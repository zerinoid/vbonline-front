...
exports.getSaibaMais = (req, res, next) => {
    data = {
        ...
        en: {
            ...
            <p>Spanning the period from 2004 to 2018, this selection reaffirms the poetic cohesion of Heráclito’s body of work and celebrates his remarkable presence in the Videobrasil Collection, reflecting several instances in which the artist’s professional carreer crossed paths with Videobrasil’s activities. His earliest participations in Videobrasil – with works such as As mãos do epô, an artistic exercise that explores the usesazeite de dendê or palm oil, and Barrueco, an allegory of the transatlantic slave crossings, produced in partnership with Danilo Baratta – paved the way for the creation of Funfun, which earned him the Videobrasil residency, in 2013, at the Raw Material Company, in Dakar. Sacudimentos, featured in the 57th Venice Biennale, in 2017, and História do futuro, both of which have also been made available here, were conceived during his residency in Dakar.</p>`,
        },
    };
